...
if (surface_exists(guiSurface)) {
	...
	if (hovered && !selected) {
		...
		draw_sprite_ext(spr_linebehind, -1, x - offset, y - offset, 1, 1, 0, obj_draw_handler.color_limited, 1);
	}
	else {
		draw_sprite_ext(spr_linebehind, -1, x, y, 1, 1, 0, obj_draw_handler.color_limited, 1);
	}
	...
	if (hovered) {
		...
		tool_desc = "Useful for coloring!";
		tool_desc2 = "Draws a line in the background with no shake.";
